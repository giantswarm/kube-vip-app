[![CircleCI](https://dl.circleci.com/status-badge/img/gh/giantswarm/kube-vip-app/tree/main.svg?style=svg)](https://dl.circleci.com/status-badge/redirect/gh/giantswarm/kube-vip-app/tree/main)

[Read me after cloning this template (GS staff only)](https://handbook.giantswarm.io/docs/dev-and-releng/app-developer-processes/adding_app_to_appcatalog/)

# kube-vip chart

Giant Swarm offers a kube-vip App which can be installed in workload clusters.
Here, we define the kube-vip chart with its templates and default configuration.
